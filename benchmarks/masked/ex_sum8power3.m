sdpvar n1 n2 n3 n4 n5 n6 n7 n8 s;

d = 3;

name = ["n1", "n2", "n3", "n4", "n5","n6", "n7", "n8","s"];

yvars = [n1, n2, n3, n4, n5, n6, n7, n8];
zvars = [s];
...
% while body
f = [ [n1+1, n2+1, n3+1, n4+1, n5+1, n6+1, n7+1, n8+1, s+(n1+n2+n3+n4+n5+n6+n7+n8+8)^d-(n1+n2+n3+n4+n5+n6+n7+n8)^d]];

% pre-condition
pre_cond = [s-(n1+n2+n3+n4+n5+n6+n7+n8)^d, (n1+n2+n3+n4+n5+n6+n7+n8)^d-s];
